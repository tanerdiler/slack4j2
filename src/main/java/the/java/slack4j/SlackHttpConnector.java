 ...
 */
public class SlackHttpConnector implements AutoCloseable
{
    private String webhook;
    private HttpURLConnection connection;

    private SlackHttpConnector(String webhook)
    {
        this.webhook = webhook;
    }

    public static final SlackHttpConnector to(String webhook)
    {
        return new SlackHttpConnector(webhook);
    }

    public SlackHttpConnector connect() throws SlackConnectionException
    {
        URL url = null;
        try
        {
    ...
    public SlackHttpConnector send(SlackMessage message)
    {
    ...
    public static void main(String[] args)
    {
        ...
        SlackHttpConnector connector = null;
        try
        {
            connector = SlackHttpConnector.to("https://hooks.slack.com/services/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")
                              .connect()
                              .send(message);
        } catch (Exception e)
        {
